# `StarPU_jll.jl` (v1.3.9+0)

[![deps](https://juliahub.com/docs/StarPU_jll/deps.svg)](https://juliahub.com/ui/Packages/StarPU_jll/wcVLu?page=2)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/81c349627bd4778186353f659a2870bc520c2c55/S/StarPU/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `StarPU_jll.jl` have been built from these sources:

* compressed archive: https://files.inria.fr/starpu/starpu-1.3.9/starpu-1.3.9.tar.gz (SHA256 checksum: `73adf2a5d25b04023132cfb1a8d9293b356354af7d1134e876122a205128d241`)
* files in directory, relative to originating `build_tarballs.jl`: [`./bundled`](https://github.com/JuliaPackaging/Yggdrasil/tree/81c349627bd4778186353f659a2870bc520c2c55/S/StarPU/bundled)

## Platforms

`StarPU_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `StarPU_jll.jl`:
